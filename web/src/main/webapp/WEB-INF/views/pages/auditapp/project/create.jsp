...
<div class="content">
  <div class="col-12">
    <div class="card">
      ...
      <%--@elvariable id="appProject" type="com.ideaas.services.domain.AppProject"--%>
      <form:form autocomplete="off" action="save" modelAttribute="appProject" method="post">
        <div class="row ml-3">
          <div class="col-md-11">
            <div class="form-group">
              <div class="row">
                <div class="col-6">
                  <label for="nombre" class="control-label">Nombre Proyecto:</label>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <h5>&iquest;Desea guardar un nuevo proyecto?</h5>
                  </div>
