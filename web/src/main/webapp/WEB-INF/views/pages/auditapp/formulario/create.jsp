...
<div class="content">
    <div class="col-12">
        <div class="card">
            <form:form autocomplete="off" action="save" modelAttribute="appFormulario" method="post">
                <div class="row ml-3">
                    <div class="col-md-11">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-6">
                                    <label for="nombre" class="control-label">Nombre del formulario:</label>
                                    <form:input path="nombreFormulario" cssClass="form-control" id="nombre" placeholder="*Obligatorio"/>
                        ...
                        <form:input  type="hidden" path="bajaLogicaFormulario" value="0" cssClass="form-control"/>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <h5>&iquest;Desea guardar un nuevo formulario?</h5>
                                    </div>
