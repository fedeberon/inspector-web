...
<div class="content">
    <div class="col-12">
        <div class="card">
            <%--@elvariable id="parametro" type="com.ideaas.services.domain.Parametro"--%>
            <form:form action="save" autocomplete="off" modelAttribute="parametro" method="post">
                <div class="row ml-3">
                    <div class="col-md-11">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <form:input  path="nombre" cssClass="form-control" id="street1_id" name="street1" placeholder="Ingrese un nuevo nombre"/>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <h5>&iquest;Desea guardar un nuevo par&aacute;metro?</h5>
                                    </div>
