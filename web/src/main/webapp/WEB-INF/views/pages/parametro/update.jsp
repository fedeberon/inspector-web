...
<div class="content">
    <div class="col-12">
        <div class="card">
            <form:form action="save" modelAttribute="updateParametro" method="post">
                <form:hidden path="idParametro" value='${updateParametro.idParametro}'/>
                <div class="row ml-3">
                    <div class="col-md-11">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <form:input  path="nombre" cssClass="form-control" id="street1_id" name="street1" placeholder=""/>
                                </div>
                            </div>
                        </div>
