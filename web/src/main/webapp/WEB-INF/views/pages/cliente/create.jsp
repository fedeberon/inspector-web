...
<div class="content">
    <div class="col-12">
        <div class="card">
            <%--@elvariable id="cliente" type="com.ideaas.services.domain.MapCliente"--%>
            <div class="row m-0">
            <form:form action="save" autocomplete="off" modelAttribute="cliente" method="post" cssClass="w-100 m-0">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <h5>&iquest;Desea guardar un nuevo cliente?</h5>
                                </div>
                                <div class="modal-footer">
                                    <button type="#" class="btn btn-light" data-dismiss="modal">Cancelar</button>
                                    <button type="submit" form="cliente" class="btn btn-secondary btn-fill">Guardar</button>
                                </div>
                            </div>
                        </div>
                    </div>
